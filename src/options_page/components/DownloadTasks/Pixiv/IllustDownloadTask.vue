    ...
    <v-card-title style="display:block;">
      ...
      <div class="download-task__section">
        ...
        <div class="download-task__actions">
          <span class="download-task__action" @click="$emit('delete', data)">{{ tl('_delete') }}</span>
        </div>
      </div>
    </v-card-title>
    <div class="download-task__type-tag">Pixiv Illustration</div>
  </v-card>
</template>

<script>
export default {
  name: 'pixiv-illust-download-task',

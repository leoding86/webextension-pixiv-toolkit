...
window.Whammy = (function(){
  ...
  WhammyVideo.prototype.listeners = {
    progress: null,
    finished: null
  };

  WhammyVideo.prototype.on = function(event, listener) {
  ...
  WhammyVideo.prototype.encodeFrames = function(callback){
    ...
    if(this.frames[0].image instanceof ImageData){
      ...
      var encodeFrame = function(index){
        ...
        if (this.listeners['progress'] !== null) {
          this.listeners['progress'](this.frames.length, index + 1);
        }
